...
- Abstract day-part words resolve to a representative clock hour (새벽 06:00, 아침 08:00, 오전 10:00, 점심 12:00, 오후 15:00, 저녁 18:00, 밤 21:00); the parser no longer sets the evening flag (the domain's "This Evening" picker still does). Bare hours with no meridiem are disambiguated to PM (1–6 always; 7–11 only once today's morning reading has passed).
