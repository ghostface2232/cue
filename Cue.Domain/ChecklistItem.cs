...
/// sync. It carries only what a checklist needs — a title, a checked flag, and an optional memo — with
/// no date, tag, priority, or recurrence of its own, and it can never nest. Ordering is the position
...
public sealed class ChecklistItem
{
    ...
    /// <summary>Optional free-form memo for the item, stored as Markdown. <c>null</c> when empty.</summary>
